...
{
public:
    static void handleMessage(const Message& message, const ChatEventHandler& eventHandler) noexcept;
private:
    ...
    static void handleStandardMessage(
        const Message& message, const ChatEventHandler& eventHandler) noexcept;
