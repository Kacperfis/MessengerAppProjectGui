...
bool ServerCore::loginAdmin(const std::string& login, const std::string& password)
{
...
bool ServerCore::registerAdmin(const std::string& login, const std::string& password)
{
